    ...
    <>
      ...
      <div className="flex items-center space-x-4 md:space-x-5 lg:space-x-6 justify-center">
        <Image
          ...
          height={48}
        />
        <h1 className="text-5xl">Crystopia.net | Terms of Service</h1>
      </div>
      <br></br> <br></br>
      <div className="ml-48 mt-10 text-white">
        ...
        <p></p>
        <p className="mt-4 mb-10 font-minecraftseven text-3xl">
          EXTRA AND EXPANSION
        </p>
        <p></p>
        <p className="mt-4 mb-10 font-minecraftseven text-3xl">
        ...
        <p>
          ...
          graphics, logos, and software, is the property of [Your Company Name]
